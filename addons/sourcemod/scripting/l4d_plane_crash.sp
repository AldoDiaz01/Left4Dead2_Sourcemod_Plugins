...
public void OnPluginStart()
{
	...
	CreateConVar(							"l4d_plane_crash_version",		PLUGIN_VERSION, "Plane Crash plugin version.", CVAR_FLAGS|FCVAR_DONTRECORD);
...
public int VMaxsMenuHandler(Menu menu, MenuAction action, int client, int index)
{
	...
	{
		if( index == 0 )
			SaveMaxMin(1, view_as<float>({ 10.0, 10.0, 100.0 }));
		else if( index == 1 )
			SaveMaxMin(1, view_as<float>({ 25.0, 25.0, 100.0 }));
		else if( index == 2 )
			SaveMaxMin(1, view_as<float>({ 50.0, 50.0, 100.0 }));
		else if( index == 3 )
			SaveMaxMin(1, view_as<float>({ 100.0, 100.0, 100.0 }));
		else if( index == 4 )
			SaveMaxMin(1, view_as<float>({ 150.0, 150.0, 100.0 }));
		else if( index == 5 )
			SaveMaxMin(1, view_as<float>({ 200.0, 200.0, 100.0 }));
		else if( index == 6 )
			SaveMaxMin(1, view_as<float>({ 300.0, 300.0, 100.0 }));
...
public int VMinsMenuHandler(Menu menu, MenuAction action, int client, int index)
{
	...
	{
		if( index == 0 )
			SaveMaxMin(2, view_as<float>({ -10.0, -10.0, 0.0 }));
		else if( index == 1 )
			SaveMaxMin(2, view_as<float>({ -25.0, -25.0, 0.0 }));
		else if( index == 2 )
			SaveMaxMin(2, view_as<float>({ -50.0, -50.0, 0.0 }));
		else if( index == 3 )
			SaveMaxMin(2, view_as<float>({ -100.0, -100.0, 0.0 }));
		else if( index == 4 )
			SaveMaxMin(2, view_as<float>({ -150.0, -150.0, 0.0 }));
		else if( index == 5 )
			SaveMaxMin(2, view_as<float>({ -200.0, -200.0, 0.0 }));
		else if( index == 6 )
			SaveMaxMin(2, view_as<float>({ -300.0, -300.0, 0.0 }));
