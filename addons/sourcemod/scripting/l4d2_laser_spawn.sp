...
*	Link	:	http://forums.alliedmods.net/showthread.php?t=223012
...
public Plugin myinfo =
{
	...
	url = "http://forums.alliedmods.net/showthread.php?t=223012"
}
...
public void OnPluginStart()
{
	...
	g_hCvarRandom =		CreateConVar(	"l4d2_laser_spawn_random",		"-1",			"-1=All, 0=None. Otherwise randomly select this many Laser Boxes to spawn from the maps confg.", CVAR_FLAGS );
	CreateConVar(						"l4d2_laser_spawn_version",		PLUGIN_VERSION, "Laser Spawner plugin version.", CVAR_FLAGS|FCVAR_DONTRECORD);
...
public Action CmdSpawnerTemp(int client, int args)
{
	if( !client )
	{
		ReplyToCommand(client, "[Laser Spawner] Commands may only be used in-game on a dedicated server..");
